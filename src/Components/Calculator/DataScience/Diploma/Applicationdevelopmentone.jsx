...
function Applicationdevelopmentone() {
  ...
  const handlescore = () => {
    ...
    const {QUIZ1,QUIZ2,"END TERM":END_TERM,GLA,GAA,'BONUS MARKS':bonusmark} = updatedParameters;
...
export default Applicationdevelopmentone