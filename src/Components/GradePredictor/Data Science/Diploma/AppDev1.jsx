  ...
  useEffect(() => {
    ...
    setTotalScoreF1(
      (
        ...
        0.15 * parseFloat(subjectParameters["Graded Lab Assignment"]) +
        Score1 +
    ...
    const PassGF1 =
      calculateGrade(40 - (TotalScoreF1 - subjectParameters.Bonus), 35) > 0
        ? calculateGrade(40 - (TotalScoreF1 - subjectParameters.Bonus), 35)
        : "Already";
    ...
    const PassGF2 =
      calculateGrade(40 - (TotalScoreF2 - subjectParameters.Bonus), 40) > 0
        ? calculateGrade(40 - (TotalScoreF2 - subjectParameters.Bonus), 40)
        : "Already";
    const DF2 = calculateGrade(50 - TotalScoreF2, 40);
    const DGF2 =
      calculateGrade(50 - TotalScoreF2, 40) > 0
        ? calculateGrade(50 - TotalScoreF2, 40)
        : "Already";
    const CF2 = calculateGrade(60 - TotalScoreF2, 40);
    const CGF2 =
      calculateGrade(60 - TotalScoreF2, 40) > 0
        ? calculateGrade(60 - TotalScoreF2, 40)
        : "Already";

    const BF2 = calculateGrade(70 - TotalScoreF2, 40);
    const BGF2 =
      calculateGrade(70 - TotalScoreF2, 40) > 0
        ? calculateGrade(70 - TotalScoreF2, 40)
        : "Already";

    const AF2 = calculateGrade(80 - TotalScoreF2, 40);
    const AGF2 =
      calculateGrade(80 - TotalScoreF2, 40) > 0
        ? calculateGrade(80 - TotalScoreF2, 40)
        : "Already";
    const SF2 = calculateGrade(90 - TotalScoreF2, 40);
    const SGF2 =
      calculateGrade(90 - TotalScoreF2, 40) > 0
        ? calculateGrade(90 - TotalScoreF2, 40)
        : "Already";
