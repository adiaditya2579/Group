...
const DBManagement = ({
  ...
  useEffect(() => {
    ...
    setTotalScoreF1(
      (
        0.04 * parseFloat(subjectParameters["Graded Assignments"]) +
        0.03 * parseFloat(subjectParameters["SQL based Assignments"]) +
        0.03 * parseFloat(subjectParameters["Programming Assignment"]) +
