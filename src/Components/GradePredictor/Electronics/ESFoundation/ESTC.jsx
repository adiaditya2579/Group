  ...
  useEffect(() => {
    ...
    setTotalScoreF1(
      (
        ...
        0.15 * parseFloat(subjectParameters.Lab) +
        Score1 +
    ...
    const PassGF2 =
      calculateGrade(40 - (TotalScoreF2 - subjectParameters.Bonus), 55) > 0
        ? calculateGrade(40 - (TotalScoreF2 - subjectParameters.Bonus), 55)
        : "Already";
    const DF2 = calculateGrade(50 - TotalScoreF2, 55);
    const DGF2 =
      calculateGrade(50 - TotalScoreF2, 55) > 0
        ? calculateGrade(50 - TotalScoreF2, 55)
        : "Already";
    const CF2 = calculateGrade(60 - TotalScoreF2, 55);
    const CGF2 =
      calculateGrade(60 - TotalScoreF2, 55) > 0
        ? calculateGrade(60 - TotalScoreF2, 55)
        : "Already";
    const BF2 = calculateGrade(70 - TotalScoreF2, 55);
    const BGF2 =
      calculateGrade(70 - TotalScoreF2, 55) > 0
        ? calculateGrade(70 - TotalScoreF2, 55)
        : "Already";

    const AF2 = calculateGrade(80 - TotalScoreF2, 55);
    const AGF2 =
      calculateGrade(80 - TotalScoreF2, 55) > 0
        ? calculateGrade(80 - TotalScoreF2, 55)
        : "Already";
    const SF2 = calculateGrade(90 - TotalScoreF2, 55);
    const SGF2 =
      calculateGrade(90 - TotalScoreF2, 55) > 0
        ? calculateGrade(90 - TotalScoreF2, 55)
        : "Already";
